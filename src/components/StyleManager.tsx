    ...
    <div className="space-y-12">
                    ...
                    <div className="pt-4 border-t border-white/5">
                      ...
                      <div className="flex flex-wrap gap-3">
                        ...
                        {analysisResult.color_system?.accent_hex && (
                           <div className="w-10 h-10 rounded-xl border-2 border-blue-600/30 p-0.5">
                  ...
                  <div className="flex items-center gap-3 px-2">
                    <button
                      ...
                      className={cn(
                        ...
                        isGlobal ? "bg-blue-600" : "bg-white/10"
                      )}
                    >
                      <div className={cn(
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
          {styles.map(style => (
            <div key={style.id} className="group relative aspect-[4/5] bg-[#111] rounded-[2rem] overflow-hidden border border-white/5 hover:border-blue-600/30 transition-all">
