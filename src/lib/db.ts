  ...
  try {
    ...
    await query(`
      ...
      VALUES 
        ...
        ('carousel_daily_limit_per_user', '0'),
    ...
    const columnAdditions = [
      ...
      "ALTER TABLE publications ADD COLUMN IF NOT EXISTS type TEXT DEFAULT 'video'",
      "ALTER TABLE publications ADD COLUMN IF NOT EXISTS status TEXT DEFAULT 'sent'",
      "ALTER TABLE publications ADD COLUMN IF NOT EXISTS control_message_id BIGINT",
      "ALTER TABLE publications ADD COLUMN IF NOT EXISTS social_links TEXT[] DEFAULT '{}'",
      ...
      "ALTER TABLE carousels ADD COLUMN IF NOT EXISTS control_message_id BIGINT",
